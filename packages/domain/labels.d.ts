...
export function isBuiltinVisibilityItem (item: unknown): boolean
...
export function buildBuiltinVisibilityItem (args: { listId: string; type: string; hidden: boolean; updatedAt: number }): Record<string, unknown>
...
export function reduceHiddenBuiltinSurfaces (items: unknown[] | null | undefined): Set<string>
export function isBuiltinSurfaceHidden (items: unknown[] | null | undefined, listId: string, type: string): boolean
